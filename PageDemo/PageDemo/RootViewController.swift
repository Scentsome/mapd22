...
class RootViewController: UIViewController, UIPageViewControllerDelegate {
    ...
    func pageViewController(_ pageViewController: UIPageViewController, spineLocationFor orientation: UIInterfaceOrientation) -> UIPageViewControllerSpineLocation {
        if UIInterfaceOrientationIsLandscape(orientation) {
            var previousViewController = self.storyboard?.instantiateViewController(withIdentifier: "DataViewController") as? DataViewController
            var currentViewController = self.storyboard?.instantiateViewController(withIdentifier: "DataViewController") as? DataViewController
